...
class SarsaTable(RL):
    ...
    def __init__(self, action_space, learning_rate=0.1, reward_decay=0.9, e_greedy=0.9):
        super(SarsaTable, self).__init__(action_space, learning_rate, reward_decay, e_greedy)
...
def rl():
    ...
    for episode in range(MAX_EPISODES):
        ...
        while not is_terminated:
            ...
            new_action = q_table.choose_action(new_state)
            q_table.learn(state, action, reward, new_state,new_action)
